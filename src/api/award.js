...
export function add(evaluation_id, data) {
  return Service({
    url: `/evaluation/${evaluation_id}/award/add`,
    method: 'POST',
    data
  })
}
...
export function deleteById(evaluation_id, id) {
  return Service({
    url: `/evaluation/${evaluation_id}/award/delete/${id}`,
    method: 'DELETE',
  })
}
...
export function updateById(evaluation_id, id) {
  return Service({
    url: `/evaluation/${evaluation_id}/award/${id}`,
    method: 'PUT'
  })
}
...
export function list(evaluation_id) {
  return Service({
    url: `/evaluation/${evaluation_id}/award/list`,
    method: 'GET',
  })
}
