...
export function add(evaluation_id, data) {
  return Service({
    url: `/evaluation/${evaluation_id}/experience/add`,
    method: 'POST',
    data
  })
}
...
export function deleteById(evaluation_id, id) {
  return Service({
    url: `/evaluation/${evaluation_id}/experience/delete/${id}`,
    method: 'DELETE',
  })
}
...
export function updateById(evaluation_id, id) {
  return Service({
    url: `/evaluation/${evaluation_id}/experience/${id}`,
    method: 'PUT'
  })
}
...
export function list(evaluation_id) {
  return Service({
    url: `/evaluation/${evaluation_id}/experience/list`,
    method: 'GET',
  })
}
